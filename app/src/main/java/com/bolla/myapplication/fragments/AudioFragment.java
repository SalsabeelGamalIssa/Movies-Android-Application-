       ...
       /* b1 = (Button) view.findViewById(R.id.button);
        ...
        iv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mediaPlayer = MediaPlayer.create(getContext(), Uri.parse("https://soundcloud.com/mapoftheproblematique/relaxing-sea-sounds-soothing-sound-of-nature-ocean-waves"));
